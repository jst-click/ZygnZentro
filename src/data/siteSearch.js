...
export const searchIndex = [
  ...
  { title: 'Zevive', path: '/zevive', category: 'App', keywords: 'task productivity todo team collaboration voice notes' },
  ...
  { title: 'Smart Task Management', path: '/zevive', category: 'Zevive Feature', keywords: 'tasks todo assign priority deadline' },
  { title: 'Voice Notes', path: '/zevive', category: 'Zevive Feature', keywords: 'voice record audio memo' },
  { title: 'Team Collaboration', path: '/zevive', category: 'Zevive Feature', keywords: 'team share assign sync realtime' },
  { title: 'Location Reminders', path: '/zevive', category: 'Zevive Feature', keywords: 'location gps geofence reminder field' },
  { title: 'Productivity Analytics', path: '/zevive', category: 'Zevive Feature', keywords: 'analytics charts insights progress' },
  ...
  { title: 'Download Zevive on Google Play', path: 'https://play.google.com/store/apps/details?id=com.jstclick.zentro&pcampaignid=web_share', category: 'Download', keywords: 'download install android play store Zevive', external: true },
  ...
  { title: 'FAQ — Difference between apps', path: '/', category: 'FAQ', keywords: 'faq difference zygnpro Zevive compare' },
